...
public class RecMahoutDriver {
    final static Logger logger = Logger.getLogger(RecMahoutDriver.class);
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try {
            ...
            getDataJob.setJarByClass(RecMahoutDriver.class);

            getDataJob.setMapperClass(InitialDataMapper.class);
            ...
            if(mahoutGetDataJobSuccesful) {
                ...
                recommendationJob.setJarByClass(RecMahoutDriver.class);
                ...
                recommendationJob.setMapperClass(RecMahoutMapper.class);
                recommendationJob.setReducerClass(RecMahoutReducer.class);
